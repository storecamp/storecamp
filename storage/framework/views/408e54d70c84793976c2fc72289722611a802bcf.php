...
<script src="<?php echo e(asset('plugins/fastclick/lib/fastclick.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('plugins/jquery-slimscroll/jquery.slimscroll.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('/plugins/iCheck/icheck.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/plyr/dist/plyr.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('/plugins/dropzone/dist/dropzone.js')); ?>" type="text/javascript"></script>
<!-- Select2 -->
<script src="<?php echo e(asset('plugins/select2/dist/js/select2.full.min.js')); ?>"></script>
<!-- InputMask -->
<script src="<?php echo e(asset('custom_vendors/input-mask/jquery.inputmask.js')); ?>"></script>
<script src="<?php echo e(asset('custom_vendors/input-mask/jquery.inputmask.date.extensions.js')); ?>"></script>
<script src="<?php echo e(asset('custom_vendors/input-mask/jquery.inputmask.extensions.js')); ?>"></script>
<!-- date-range-picker -->
<script src="<?php echo asset('plugins/moment/min/moment-with-locales.min.js'); ?>"></script>
...
<script src="<?php echo e(asset('plugins/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('plugins/iCheck/icheck.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(asset('plugins/fastclick/lib/fastclick.js')); ?>"></script>
<!-- Sparkline -->
<script src="<?php echo e(asset('plugins/bower-jquery-sparkline/dist/jquery.sparkline.retina.js')); ?>"></script>
<!-- jvectormap -->
<script src="<?php echo e(asset('custom_vendors/jvectormap/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('custom_vendors/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<!-- SlimScroll 1.3.0 -->
<script src="<?php echo e(asset('plugins/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- ChartJS 1.0.1 -->
...
<!-- Page script -->
<script>
    APP_URL = <?php echo json_encode(url('/')); ?>;
</script>
<script>
    $(function () {
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
      ...
      fixed layout. -->
<script src="<?php echo e(asset("js/modules.js")); ?>"></script>
