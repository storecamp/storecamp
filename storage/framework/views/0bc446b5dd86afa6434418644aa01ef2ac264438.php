...
<aside class="main-sidebar">
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 336px;">
        <section class="sidebar" style="height: 336px; overflow: hidden; width: auto;">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p><?php if($user): ?><?php echo e($user->name); ?><?php else: ?> User Not Available <?php endif; ?></p>
                    <!-- Status -->
        ...
        <button type='submit' name='search' id='search-btn' class="btn btn-flat"><i
            ...
            <?php echo app('elements.menu.manager')->menu('sidebar'); ?>

            <?php echo app('elements.menu.manager')->menu('administration'); ?>
