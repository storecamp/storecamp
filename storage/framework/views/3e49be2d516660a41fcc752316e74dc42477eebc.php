    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="word-wrap: break-word;">
                <?php echo $__env->make('admin.media.newdir-form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        ...
        $("#newDirForm").submit(function(event){
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.ajax({
                        url: "<?php echo e(route('admin::media::get.index.folders', [$disk, $folder->id])); ?>",
                        type: 'GET',
                        success: function (data) {
