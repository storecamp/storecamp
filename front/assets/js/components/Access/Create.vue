<template>
    <div class="container-fluid">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <form method="post" v-on:submit="storeRole" id="storeRole" class="col-sm-12">
                        ...
                        <div class="form-group">
                            <button v-on:click="storeRole" class="btn btn-primary btn-lg form_btn" value="Create User">Create Role</button>
                        </div>
                    </form>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        storeRole(event) {
            ...
            Vue.http.post(window.BASE_URL + '/api/access/roles/store', this.role)
                .then(response => {
                    this.error = false;
