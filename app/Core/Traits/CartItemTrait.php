...
trait CartItemTrait
{
    ...
    {
        return is_array($this->primaryKey) ? 0 : $this->getBuyableIdentifier();
    }
    ...
    {
        return ShopSystem::format($this->getBuyablePrice());
    }
    ...
    {
        return ShopSystem::format(array_key_exists('shipping', $this->attributes) ? $this->attributes['shipping'] : 0.00);
    }
